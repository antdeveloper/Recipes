...
public class RecipesAdapter extends RecyclerView.Adapter<RecipesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtRecipName.setText(currentRecipe.getTitle());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        @Bind(R.id.imgRecipe)
        ImageView imgRecipe;
        @Bind(R.id.txtRecipName)
        TextView txtRecipName;
        @Bind(R.id.imgFav)
        ImageButton imgFav;
        @Bind(R.id.imgDelete)
        ...
        public void setOnItemClickListener(final Recipe currentRecipe,
